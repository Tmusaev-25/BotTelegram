...
class mainConversation extends conversation
{
    ...
    private function setName() {
        $question = BotManQuestion::create("Привет, меня зовут Aida, какая Вам помощь требуется?");



        $question->addButtons( [
            Button::create('Выбор услуги')->value(1),
            Button::create('Информация по заявке')->value(2),
            Button::create('Сообщить о проблеме')->value(3),
            Button::create('Учетные данные ')->value(4)
        ]);
